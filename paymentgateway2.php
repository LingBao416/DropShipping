...
$SQLUpdate = mysqli_query($connection, "UPDATE cart SET itst = 'Paid' WHERE uid = '".$_SESSION['uid']."'  AND transid = '".$transid."' ");
...
<div class="col-lg-12" style="font-size: 27px; padding-bottom: 34px;"> 
         ...
         <div class="col-lg-6" style="padding-left: 0px;padding-right: 0px; border-radius: 12px; box-shadow: #000 0.0em 0.1em 0.1em 0.0em;"> 
                   <div class="col-lg-12" style="font-size: 22px;">
                       ...
                       <br/> <center> <span style="font-size: 30px;"> $<?php echo number_format($txtamt); ?></span></center><br/>
                       Your payment of <b>$<?php echo number_format($txtamt); ?></b> is successful. <p/>
