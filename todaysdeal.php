...
<head>
<meta charset="utf-8">
<title>umazon.com - Today's Deal</title>
<!-- Stylesheets -->
...
<div class="container gallery" id="gallery">
	<h2 style="text-align:center; font-size:38px; color:#000; font-family: 'Dancing Script', cursive;">Today's Deal @ Umazon.com</h2>
					...
					<li data-title="Umazon" data-desc="Lorem Ipsum is simply dummy text of the printing." data-src="images/g1.jpg" data-responsive-src="images/g1.jpg"> 
						<div class="w3layouts_gallery_grid1 box">
							<a href="#">
								...
								<div class="overbox">
									<h4 class="title overtext"> Umazon</h4>
