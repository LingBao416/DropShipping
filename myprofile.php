...
<form name="form" id="form" class="form-horizontal loginForm" action="login.php" method="POST">
...
<button type="submit" class="btn btn-primary pull-right btnLogin"><i class="glyphicon glyphicon-log-in"></i> Log in</button>                          
			...
			<div class="panel-heading">
				...
				<div class="panel-body">
<form role="form" id="registerForm" method="POST" action="account2.php" >
<div class="form-group has-error has-feedback">
     <input type="text" name="uID" class="form-control" id="name" required placeholder="*user id" />
     </div>
	 
  	<div class="form-group has-error has-feedback">
            <input type="email" name="em" class="form-control" id="email" required placeholder="*email" />
	</div>
	
  	<div class="form-group has-error has-feedback">
            <input type="password" name="pw" class="form-control" id="subject" required placeholder="*password" />
    </div>
	...
	<div class="form-group has-error has-feedback">
	 ...
	 <div class="form-group has-error has-feedback">
             ...
             <button type="submit" class="btn btn-danger btnRegister">Send</button> 
	  <input type="reset" name="reset" class="btn btn-danger btnCancel" value="Cancel" />
